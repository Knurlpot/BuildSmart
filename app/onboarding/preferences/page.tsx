...
// Part D — this page no longer advances the step itself: Step 1 -> 2 now advances the
// moment at least one Pricing Strategy rule is saved (see
// features/company-rules/components/CompanyRulesShell.tsx + lib/onboarding.ts's
// hasCompletedCompanyRulesStep). This is just the gate/CTA message — it only navigates.

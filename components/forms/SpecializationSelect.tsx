...
// Single dropdown, up to MAX_SPECIALIZATIONS checkboxes — replaces what used to be
// separate specialization_1/2/3 text inputs in both SignUp and Company Profile. Selection
// ORDER is meaningful to callers (index 0 -> _1, 1 -> _2, 2 -> _3 — see
// lib/specializations.ts's specializationsToColumns), so toggling off an earlier pick
// shifts later ones up rather than leaving a gap.

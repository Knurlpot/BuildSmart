...
export function PricingStrategyForm({ focusRuleId, onFocusHandled }: PricingStrategyFormProps) {
  ...
  const visibleStrategies = allStrategies.filter((strategy) => strategy.is_active === (statusFilter === "active"));
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <RuleListDetailPanel
        ...
        onAdd={startAdd}
        countLabel={`${allStrategies.length} configured`}
        listHeader={
        ...
        renderListItem={(s) => (
          <div className="flex flex-col gap-0.5">
            <div className="flex items-center justify-between gap-2">
              <span className="truncate text-sm font-semibold text-gray-800">{s.quotation_tier} Tier</span>
              <span

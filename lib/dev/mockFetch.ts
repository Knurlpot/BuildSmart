...
//
// Matches an endpoint STRING (as passed to useFetch, path + optional query string)
// against the fixture that backs it, by pathname — query params are ignored except
// where a fixture needs to echo one back (market-insights' item_code). This is a
// visual-review tool, not a filter simulator: the same fixture renders regardless of
// which region/category the user picks.
